<h2><a href="https://leetcode.com/problems/synonymous-sentences/">1258. Synonymous Sentences</a></h2><h3>Medium</h3><hr><p>You are given a list of equivalent string pairs <code>synonyms</code> where <code>synonyms[i] = [s<sub>i</sub>, t<sub>i</sub>]</code> indicates that <code>s<sub>i</sub></code> and <code>t<sub>i</sub></code> are equivalent strings. You are also given a sentence <code>text</code>.</p>
