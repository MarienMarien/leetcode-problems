<h2><a href="https://leetcode.com/problems/minimum-moves-to-get-a-peaceful-board/?envType=weekly-question&envId=2024-08-15">3189. Minimum Moves to Get a Peaceful Board</a></h2><h3>Medium</h3><hr><p>Given a 2D array <code>rooks</code> of length <code>n</code>, where <code>rooks[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> indicates the position of a rook on an <code>n x n</code> chess board. Your task is to move the rooks <strong>1 cell </strong>at a time vertically or horizontally (to an <em>adjacent</em> cell) such that the board becomes <strong>peaceful</strong>.</p>
